...
import com.finpay.payment.dto.StatusTimelineEntry;
import com.finpay.payment.dto.TransactionDetailResponse;
import com.finpay.payment.dto.TransactionDetailResponse.TransactionType;
...
public class TransactionDetailService {
    ...
    public TransactionDetailResponse getTransferDetail(UUID transferId) {
        MoneyTransfer t = transferRepository.findById(transferId)
    ...
    public TransactionDetailResponse getBillPaymentDetail(UUID billPaymentId) {
        BillPayment bp = billPaymentRepository.findById(billPaymentId)
                .orElseThrow(() -> new NoSuchElementException("Bill payment not found: " + billPaymentId));
    ...
    public TransactionDetailResponse getMoneyRequestDetail(UUID requestId) {
        MoneyRequest mr = moneyRequestRepository.findById(requestId)
                .orElseThrow(() -> new NoSuchElementException("Money request not found: " + requestId));
