...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Mail, href: 'mailto:hello@finpay.com', label: 'Email' },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-dark-400 text-sm mb-6 max-w-xs">
              The future of payments. Fast, secure, and built for the modern world.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-dark-800/50 rounded-lg flex items-center justify-center text-dark-400 hover:text-white hover:bg-dark-700/50 transition-all duration-200"
